...
,trip.airport_fee
from {{ref('stg_trips')}} trip
left join {{ source('taxi_external', 'zones') }} zone1 on trip.PULocationID = zone1.LocationID
left join {{ source('taxi_external', 'zones') }} zone2 on trip.DOLocationID = zone2.LocationID